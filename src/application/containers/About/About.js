...
const sonwScene = (parentElement, bgImage) => {
    ...
    function infrastructure(url){
        ...
        let textureSquares = textureLoader.load('./application/static/images/bright_squares256.png');
        textureSquares.repeat.set(50,50);
        textureSquares.wrapS = textureSquares.wrapT = THREE.RepeatWrapping;
        textureSquares.magFilter = THREE.NearestFilter;
        textureSquares.format = THREE.RGBFormat;

        let textureNoiseColor = textureLoader.load('./application/static/images/disturb.jpg');
        ...
        let textureLava = textureLoader.load('./application/static/images/lavatile.jpg');
